/*
 *  $Id: nanotop.c, v 1.0 2006/03/16 14:30:48
...
#define MAGIC "\x00\x00"         // first two bytes of file are always zero
...
nanotop_load(const gchar *filename)
{
    ...
    memcpy(&spmfile, buffer, sizeof(SPMFile));               // fill header of data file
