...
drift_dialog(DriftArgs *args, GwyContainer *data)
{
    ...
    controls.method = gwy_option_menu_create(methods, G_N_ELEMENTS(methods),
                                     "method",
    ...
    controls.interpolation = gwy_option_menu_interpolation(G_CALLBACK(drift_invalidate),
                            ...
                            DriftArgs *args)
{
    ...
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(controls->is_crop),
                                 args->is_crop);
    gwy_option_menu_set_history(controls->method, "method",
                                args->method);
    gwy_option_menu_set_history(controls->interpolation, "interpolation-type",
                                args->interpolation);
}
                          ...
                          DriftArgs *args)
{
    ...
    args->method
        = gwy_option_menu_get_history(controls->method, "method");
    args->interpolation
        = gwy_option_menu_get_history(controls->interpolation, "interpolation-type");
}
