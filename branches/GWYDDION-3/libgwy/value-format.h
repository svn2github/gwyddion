...
GwyValueFormat* gwy_value_format_new         (void);
...
const gchar*    gwy_value_format_print_number(GwyValueFormat *format,
                                              gdouble value);
const gchar*    gwy_value_format_get_units   (GwyValueFormat *format);
void            gwy_value_format_set_units   (GwyValueFormat *format,
                                              const gchar *units);
const gchar*    gwy_value_format_get_glue    (GwyValueFormat *format);
