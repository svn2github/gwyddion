...
void test_mask_field_transpose        (void);
void test_mask_field_rotate           (void);
...
void test_field_statistics            (void);
void test_field_surface_area          (void);
void test_field_row_level_mean        (void);
void test_field_row_level_median      (void);
void test_field_row_level_mean_diff   (void);
void test_field_row_level_median_diff (void);
...
void test_fit_func_builtin_exponential(void);
void test_fit_func_user               (void);
...
main(int argc, char *argv[])
{
    ...
    g_test_add_func("/testlibgwy/mask-field/logical-part", test_mask_field_logical_part);
    ...
    g_test_add_func("/testlibgwy/mask-field/count-rows", test_mask_field_count_rows);
    ...
    g_test_add_func("/testlibgwy/mask-field/transpose", test_mask_field_transpose);
    g_test_add_func("/testlibgwy/mask-field/rotate", test_mask_field_rotate);
    ...
    g_test_add_func("/testlibgwy/field/statistics", test_field_statistics);
    g_test_add_func("/testlibgwy/field/surface-area", test_field_surface_area);
    g_test_add_func("/testlibgwy/field/row-level/mean", test_field_row_level_mean);
    g_test_add_func("/testlibgwy/field/row-level/median", test_field_row_level_median);
    g_test_add_func("/testlibgwy/field/row-level/mean-diff", test_field_row_level_mean_diff);
    g_test_add_func("/testlibgwy/field/row-level/median-diff", test_field_row_level_median_diff);
    ...
    g_test_add_func("/testlibgwy/fit-func/builtin/exponential", test_fit_func_builtin_exponential);
    g_test_add_func("/testlibgwy/fit-func/user", test_fit_func_user);
