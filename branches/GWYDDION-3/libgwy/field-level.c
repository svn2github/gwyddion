...
fail:
    ...
    _gwy_assign_unit(&shifts->priv->unit_x, field->priv->unit_x);
    _gwy_assign_unit(&shifts->priv->unit_x, field->priv->unit_y);
    _gwy_assign_unit(&shifts->priv->unit_y, field->priv->unit_z);
