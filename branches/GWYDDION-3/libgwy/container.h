...
#define gwy_container_gis_char_by_name(c,n,v)    gwy_container_gis_char(c,g_quark_from_string(n),v)
...
#define gwy_container_get_boxed_by_name(c,n,t)   gwy_container_get_boxed(c,g_quark_try_string(n),t)
#define gwy_container_gis_boxed_by_name(c,n,t,v) gwy_container_gis_boxed(c,g_quark_from_string(n),t,v)
