...
typedef enum {
    GWY_BRICK_COMPAT_XRES    = 1 << (0 + GWY_DIMENSION_X),
    GWY_BRICK_COMPAT_YRES    = 1 << (0 + GWY_DIMENSION_Y),
    GWY_BRICK_COMPAT_ZRES    = 1 << (0 + GWY_DIMENSION_Z),
    GWY_BRICK_COMPAT_RES     = GWY_BRICK_COMPAT_XRES | GWY_BRICK_COMPAT_YRES | GWY_BRICK_COMPAT_ZRES,
    GWY_BRICK_COMPAT_XREAL   = 1 << (3 + GWY_DIMENSION_X),
    GWY_BRICK_COMPAT_YREAL   = 1 << (3 + GWY_DIMENSION_Y),
    GWY_BRICK_COMPAT_ZREAL   = 1 << (3 + GWY_DIMENSION_Z),
    GWY_BRICK_COMPAT_REAL    = GWY_BRICK_COMPAT_XREAL | GWY_BRICK_COMPAT_YREAL | GWY_BRICK_COMPAT_ZREAL,
    GWY_BRICK_COMPAT_DX      = 1 << (6 + GWY_DIMENSION_X),
    GWY_BRICK_COMPAT_DY      = 1 << (6 + GWY_DIMENSION_Y),
    GWY_BRICK_COMPAT_DZ      = 1 << (6 + GWY_DIMENSION_Z),
    ...
    GWY_BRICK_COMPAT_X       = 1 << (9 + GWY_DIMENSION_X),
    GWY_BRICK_COMPAT_Y       = 1 << (9 + GWY_DIMENSION_Y),
    GWY_BRICK_COMPAT_LATERAL = GWY_BRICK_COMPAT_X | GWY_BRICK_COMPAT_Y,
    GWY_BRICK_COMPAT_Z       = 1 << (9 + GWY_DIMENSION_Z),
    GWY_BRICK_COMPAT_SPACE   = GWY_BRICK_COMPAT_LATERAL | GWY_BRICK_COMPAT_Z,
    GWY_BRICK_COMPAT_VALUE   = 1 << (9 + GWY_DIMENSION_W),
