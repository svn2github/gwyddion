...
void                  gwy_shapes_set_snapping            (GwyShapes *shapes,
                                                          GwyShapesSnappingType snap);
GwyShapesSnappingType gwy_shapes_get_snapping            (const GwyShapes *shapes)               G_GNUC_PURE;
...
void                  gwy_shapes_snap                    (const GwyShapes *shapes,
                                                          GwyXY *xy);
